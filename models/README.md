...
1. `notebooks/01_capstone1_baseline.ipynb` — trains baseline LR and SVM models
2. `notebooks/04_train_model_clean.ipynb` — trains the full pipeline through to the hybrid BERT + LightGBM deployment bundle
