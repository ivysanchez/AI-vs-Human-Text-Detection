...
| `06_confusion_matrix_rf.png` | RF confusion matrix on deduplicated SR test set | Part 6 |
...
| `10_confusion_matrix_bert.png` | Hybrid BERT confusion matrix — real LLM eval | Part 11 |
